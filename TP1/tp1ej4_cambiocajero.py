...
def calcular_cambio(compra: int, recibido: int) -> int:
    """
    Hace la resta para calcular cuánto de cambio hay entre lo recibido y el total de la compra

    Pre: Ingresan dos números positivos, recibido debe ser mayor a compra
    Post: Devuelve la resta entre recibido y compra
    """
...
def main():
    while True:
        ...
        cambio = calcular_cambio(total_compra, total_recibido)
