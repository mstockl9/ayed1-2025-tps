...
def validar_fecha_egreso(fecha_ingreso: str, fecha_egreso: str) -> bool:
    ...
    return anio_e > anio_i or mes_e > mes_i or dia_e > dia_i
...
def validar_dni(dni: str, ruta_hospital: str) -> bool:
    """
    ...
    separador = ","
    try:
        with open(ruta_hospital, "rt", encoding="utf-8-sig") as archivo:
    ...
    while True:
        ...
        while True:
            while True:
                ...
                ingreso_formateado = "0"*(2-len(dia_ingreso)) + dia_ingreso + "0"*(2-len(mes_ingreso)) + mes_ingreso + anio_ingreso
            ...
            while True:
                ...
                egreso_formateado = "0"*(2-len(dia_egreso)) + dia_egreso + "0"*(2-len(mes_egreso)) + mes_egreso + anio_egreso
